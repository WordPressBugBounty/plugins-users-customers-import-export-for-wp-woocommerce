...
if ( ! class_exists( 'Wbte_Smart_Coupons_Analytics_Banner' ) ) {
    ...
    class Wbte_Smart_Coupons_Analytics_Banner {
        ...
        public function enqueue_styles() {
            ...
            wp_enqueue_style('wt-u-iew-smart-coupons-analytics-banner',plugin_dir_url(__FILE__) . 'assets/css/wbte-smart-coupons-analytics-banner.css',array(),WT_U_IEW_VERSION);
            wp_enqueue_script('wt-u-iew-smart-coupons-analytics-banner',plugin_dir_url(__FILE__) . 'assets/js/wbte-smart-coupons-analytics-banner.js',array('jquery'),WT_U_IEW_VERSION,true);

            wp_localize_script('wt-u-iew-smart-coupons-analytics-banner', 'wbte_smart_coupons_analytics_banner_params', array(
                    ...
                    <div class="wbte_sc_box">
                        <div class="wbte_sc_text">
                            <div class="wbte_sc_header">
                                <img src="<?php echo esc_url( WT_U_IEW_PLUGIN_URL . 'admin/banner/assets/images/idea_bulb_orange.svg' ); ?>" alt="">
                                <span class="wbte_sc_title"><?php esc_html_e( 'Did you know?', 'users-customers-import-export-for-wp-woocommerce' ); ?></span>
                            </div>
                            <div class="wbte_sc_body">
                                ...
                                echo wp_kses_post(
                                    sprintf(
                                        ...
                                        __( 'WebToffee Smart Coupons lets you create %1$s, %2$s, and %3$s to help grow your store\'s revenue.', 'users-customers-import-export-for-wp-woocommerce' ),
                                        '<strong>' . esc_html__( 'BOGO offers', 'users-customers-import-export-for-wp-woocommerce' ) . '</strong>',
                                        '<strong>' . esc_html__( 'giveaways', 'users-customers-import-export-for-wp-woocommerce' ) . '</strong>',
                                        '<strong>' . esc_html__( 'store credits', 'users-customers-import-export-for-wp-woocommerce' ) . '</strong>'
                                    )
                                );
                                ?>
                            </div>
                        ...
                        <div class="wbte_sc_actions">
                            <a href="<?php echo esc_url( $sale_link ); ?>" class="btn-primary" target="_blank"><?php esc_html_e( 'Get Plugin Now', 'users-customers-import-export-for-wp-woocommerce' ); ?></a>
