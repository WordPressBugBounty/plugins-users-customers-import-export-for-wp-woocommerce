			...
			<script type="text/javascript">
				jQuery(document).ready(function($){					
					...
					if ( ! defined( 'WBTE_BFCM_SC_COUPONS_PAGE' ) && ! in_array( 'sc_cpns_page', $hidden_banners, true ) ) {
						...
						$campaign_url = 'https://www.webtoffee.com/product/smart-coupons-for-woocommerce/?utm_source=free_plugin_add_coupon_menu&utm_medium=user_import_basic&utm_campaign=smart_coupons';
						...
						$bulk_plugin_text = sprintf(
							...
							sprintf(
								__( 'WebToffee Smart Coupons lets you create advanced %1$s and %2$s to boost sales and revenue.', 'users-customers-import-export-for-wp-woocommerce' ),
								'<strong>' . esc_html__( 'BOGO offers', 'users-customers-import-export-for-wp-woocommerce' ) . '</strong>',
								'<strong>' . esc_html__( 'condition-based coupons', 'users-customers-import-export-for-wp-woocommerce' ) . '</strong>'
							),
